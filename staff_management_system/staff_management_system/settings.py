...
SECRET_KEY = 'django-insecure-)wvc*#p-v_u((o^q7tki%rldb727@t))eg=bf2wjl*va&m5u4!'
...
if DATABASE_URL:
    ...
    # Fallback to your local MySQL settings
...
AUTH_USER_MODEL = 'human_resources.CustomUser'
